            ...
            return {
                ...
                data: res.map((item) => {
                    ...
                    return {
                        ...
                        invoice_status: parseFloat(totalBayar as any) == parseFloat(item.total as any) ? 'LUNAS' : 'BELUM LUNAS',
        ...
        try {
            ...
            return {
                ...
                data: {
                    ...
                    kembali: res.kembali,
                    is_cash: res.is_cash,
                    invoice_status: parseFloat(total_bayar as any) == parseFloat(res.total as any) ? 'LUNAS' : 'BELUM LUNAS',
